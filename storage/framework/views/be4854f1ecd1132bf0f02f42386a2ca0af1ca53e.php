...
<body class="skin-blue fixed-layout">
    ...
    <div id="main-wrapper">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/wallet" aria-expanded="false"><i class="ti-wallet"></i><span class="hide-menu">Wallet</span></a>
                         ...
                         <li> <a class="waves-effect waves-dark" href="/support" aria-expanded="false"><i class="fa fa-sort-amount-asc"></i><span class="hide-menu">Support</span></a>
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2020 MLM Solution, All Rights Reserved.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
