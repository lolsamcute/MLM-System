                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="sing-in-mockup md-mrb-60">
                            <img src="assets/images/others/signin-mockup.png" alt="E-earners">
                        </div>
                    </div><!--/.col-lg-2-->
                    <div class="col-lg-6">
                        <div class="user-register-area">
                            <div class="form-content">
                                ...
                                <form class="default-form signin-form" method="POST" action="<?php echo e(route('login')); ?>">
                                    <?php echo csrf_field(); ?>

                                    <div class="form-group">
                                        <label for="email">Email Address</label>
                                        <input class="form-controller"  name="email" type="text" required="" placeholder="Username or Email"> </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  class="form-controller" type="password" name="password" required="" placeholder="Password"> </div>
                                    ...
                                    <div class="remember-and-password">
                                        <div class="login-form-remember">
                                            <label><input name="remember" type="checkbox" id="remembermesignin <?php echo e(old('remember') ? 'checked' : ''); ?>"><span>Keep me looged in</span></label>
                                        </div>
                                        <div class="forget-pass">
                                            <a class="btn-password" id="to-recover" href="#!">Forget Password</a>
                                        </div>
                                    ...
                                    <div class="form-btn-group">
                                        ...
                                        <div class="login-form-register-now">
                                            You have no account ? <a class="btn-register-now" href="/register">Sign Up</a>
                                        </div>
                                    </div>
