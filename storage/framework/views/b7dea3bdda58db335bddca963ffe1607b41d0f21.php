...
<body>
    ...
    <div class="site-content">
        ...
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div class="faqs-form-block bg-primary ptb-120" style="background-image: url('assets/images/shape/shape-dot4.png')">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contact-call-info" data-animate="hg-fadeInUp">
                            <h2 class="call-heading">Call Us</h2>
                            <h3 class="call-no">888 555 8888</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="faqs-form-area">
                            <h2 class="section-heading" data-animate="hg-fadeInUp">Ask Your Question</h2>
                            <form class="faqs-form" action="#">
                                <div class="row" data-animate="hg-fadeInUp">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 mrt-5">
                                        <button type="submit" class="btn btn-default btn-white">Send Message</button>
                                    </div><!--./ col-lg-6 -->
                                </div><!-- /.row -->
                            </form><!-- /.faqs-form -->
                        </div><!-- /.faqs-form-area -->
