                                    ...
                                    <nav class="menu">
                                        <ul id="nav">
                                            ...
                                            <li >
                                                    ...
                                                    <?php else: ?>
                                                    <a class="active btn btn-default btn-white" href="<?php echo e(route('login')); ?>">Login</a>
                    ...
                    <div class="col-lg-6">
                        <div class="user-register-area">
                            <div class="form-content">
                                ...
                                <form class="default-form signup-form" method="POST" action="<?php echo e(route('register')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="f_name">Name</label>
                                                <input class="form-controller<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e(old('name')); ?>" type="text"  placeholder="Name" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-controller <?php echo e($errors->has('username') ? ' is-invalid' : ''); ?>" name="username" value="<?php echo e(old('username')); ?>"  type="text" required="" placeholder="Username">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-controller<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e(old('phone')); ?>"  type="text" required="" placeholder="Phone Number">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-controller<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" value="<?php echo e(old('email')); ?>" type="email" required="" placeholder="Email">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-controller<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password" type="password" required="" placeholder="Password">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-controller" name="by" value="<?php echo e($ref); ?>" type="text" placeholder="Referrer (Optional)">
                                            </div><!--/.form-group-->
                                        </div>
                                    </div>
